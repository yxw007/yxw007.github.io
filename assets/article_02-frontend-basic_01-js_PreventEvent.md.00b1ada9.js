import{_ as s,c as a,o as n,A as e}from"./app.e65f2004.js";const u=JSON.parse('{"title":"屏蔽：键盘按键、鼠标点击事件","description":"","frontmatter":{"title":"屏蔽：键盘按键、鼠标点击事件","author":"Potter","date":"2022-05-12 18:50","tags":["事件屏蔽"],"categories":["H5"]},"headers":[{"level":3,"title":"概要内容","slug":"概要内容","link":"#概要内容","children":[]},{"level":3,"title":"屏蔽-键盘按键","slug":"屏蔽-键盘按键","link":"#屏蔽-键盘按键","children":[]},{"level":3,"title":"屏蔽-鼠标点击","slug":"屏蔽-鼠标点击","link":"#屏蔽-鼠标点击","children":[]},{"level":3,"title":"屏蔽-BackSpace","slug":"屏蔽-backspace","link":"#屏蔽-backspace","children":[]}],"relativePath":"article/02-frontend-basic/01-js/PreventEvent.md","lastUpdated":1678949491000}'),l={name:"article/02-frontend-basic/01-js/PreventEvent.md"},p=e(`<h3 id="概要内容" tabindex="-1">概要内容 <a class="header-anchor" href="#概要内容" aria-hidden="true">#</a></h3><ul><li>屏蔽-键盘按键</li><li>屏蔽-鼠标点击</li><li>屏蔽-BackSpace</li></ul><h3 id="屏蔽-键盘按键" tabindex="-1">屏蔽-键盘按键 <a class="header-anchor" href="#屏蔽-键盘按键" aria-hidden="true">#</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">//添加按键监听</span></span>
