import{_ as i,c as s,o as a,a8 as n}from"./chunks/framework.Bou8hzLb.js";const g=JSON.parse('{"title":"Rollup插件开发","description":"","frontmatter":{"title":"Rollup插件开发","author":"Potter","date":"2022-01-15 14:15","tags":["插件","rollup"],"categories":["rollup"]},"headers":[],"relativePath":"article/03-framework/31-build-rollup/01-Rollup插件开发.md","filePath":"article/03-framework/31-build-rollup/01-Rollup插件开发.md","lastUpdated":1720419557000}'),l={name:"article/03-framework/31-build-rollup/01-Rollup插件开发.md"},e=n(`<h1 id="rollup插件开发" tabindex="-1">Rollup插件开发 <a class="header-anchor" href="#rollup插件开发" aria-label="Permalink to &quot;Rollup插件开发&quot;">​</a></h1><hr><p><img src="https://cdn.jsdelivr.net/gh/yxw007/BlogPicBed@master/img/20220115211118.png" alt="https://cdn.jsdelivr.net/gh/yxw007/BlogPicBed@master/img/20220115211118.png"></p><h3 id="options" tabindex="-1">options <a class="header-anchor" href="#options" aria-label="Permalink to &quot;options&quot;">​</a></h3><ul><li>作用：获取rollup 配置</li></ul><h3 id="buildstart" tabindex="-1">buildStart <a class="header-anchor" href="#buildstart" aria-label="Permalink to &quot;buildStart&quot;">​</a></h3><ul><li>作用：开始构建时钩子，此时可获取最后的输入配置信息</li></ul><h3 id="resolveid" tabindex="-1">resolveId <a class="header-anchor" href="#resolveid" aria-label="Permalink to &quot;resolveId&quot;">​</a></h3><ul><li>作用：此钩子可以用于路径替换操作，也可以用于终止解析操作</li><li>应用场景： <ul><li><p>定义alias，最后替换代码中的别名路径</p><pre><code>\`\`\`jsx
//1. 配置别名
alias: {
  &#39;@&#39;: &#39;./src&#39;
}
