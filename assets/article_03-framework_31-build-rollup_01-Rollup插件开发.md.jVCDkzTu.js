import{_ as i,c as s,o as a,a4 as n}from"./chunks/framework.CSXI9Sei.js";const g=JSON.parse('{"title":"Rollup插件开发","description":"","frontmatter":{"title":"Rollup插件开发","author":"Potter","date":"2022-01-15 14:15","tags":["插件","rollup"],"categories":["rollup"]},"headers":[],"relativePath":"article/03-framework/31-build-rollup/01-Rollup插件开发.md","filePath":"article/03-framework/31-build-rollup/01-Rollup插件开发.md","lastUpdated":1721027606000}'),l={name:"article/03-framework/31-build-rollup/01-Rollup插件开发.md"},e=n(`<h1 id="rollup插件开发" tabindex="-1">Rollup插件开发 <a class="header-anchor" href="#rollup插件开发" aria-label="Permalink to &quot;Rollup插件开发&quot;">​</a></h1><hr><p><img src="https://cdn.jsdelivr.net/gh/yxw007/BlogPicBed@master/img/20220115211118.png" alt="https://cdn.jsdelivr.net/gh/yxw007/BlogPicBed@master/img/20220115211118.png"></p><h3 id="options" tabindex="-1">options <a class="header-anchor" href="#options" aria-label="Permalink to &quot;options&quot;">​</a></h3><ul><li>作用：获取rollup 配置</li></ul><h3 id="buildstart" tabindex="-1">buildStart <a class="header-anchor" href="#buildstart" aria-label="Permalink to &quot;buildStart&quot;">​</a></h3><ul><li>作用：开始构建时钩子，此时可获取最后的输入配置信息</li></ul><h3 id="resolveid" tabindex="-1">resolveId <a class="header-anchor" href="#resolveid" aria-label="Permalink to &quot;resolveId&quot;">​</a></h3><ul><li>作用：此钩子可以用于路径替换操作，也可以用于终止解析操作</li><li>应用场景： <ul><li><p>定义alias，最后替换代码中的别名路径</p><pre><code>\`\`\`jsx
//1. 配置别名
alias: {
  &#39;@&#39;: &#39;./src&#39;
}
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div></li></ul><h3 id="generatebundle" tabindex="-1">generateBundle <a class="header-anchor" href="#generatebundle" aria-label="Permalink to &quot;generateBundle&quot;">​</a></h3><ul><li>作用：生成bundle钩子</li></ul><h3 id="writebundle" tabindex="-1">writeBundle <a class="header-anchor" href="#writebundle" aria-label="Permalink to &quot;writeBundle&quot;">​</a></h3><ul><li>作用：Bundle文件生成钩子</li></ul><h3 id="closebundle" tabindex="-1">closeBundle <a class="header-anchor" href="#closebundle" aria-label="Permalink to &quot;closeBundle&quot;">​</a></h3><ul><li>作用：bundle关闭钩子</li></ul><h3 id="rendererror" tabindex="-1">renderError <a class="header-anchor" href="#rendererror" aria-label="Permalink to &quot;renderError&quot;">​</a></h3><ul><li>作用：渲染出错钩子</li></ul><h2 id="参考文献" tabindex="-1">参考文献 <a class="header-anchor" href="#参考文献" aria-label="Permalink to &quot;参考文献&quot;">​</a></h2><ul><li><a href="https://rollupjs.org/guide/en/#plugins-overview" target="_blank" rel="noreferrer">https://rollupjs.org/guide/en/#plugins-overview</a></li><li><a href="https://github.com/rollup/plugins/tree/master/packages/image" target="_blank" rel="noreferrer">https://github.com/rollup/plugins/tree/master/packages/image</a></li><li><a href="https://rollupjs.org/guide/en/#build-hooks" target="_blank" rel="noreferrer">https://rollupjs.org/guide/en/#build-hooks</a></li><li><a href="https://rollupjs.org/guide/en/#output-generation-hooks" target="_blank" rel="noreferrer">https://rollupjs.org/guide/en/#output-generation-hooks</a></li></ul><blockquote><p>以上：如发现有问题，欢迎留言指出，我及时更正</p></blockquote>`,50),t=[e];function h(p,r,k,o,d,E){return a(),s("div",null,t)}const c=i(l,[["render",h]]);export{g as __pageData,c as default};
