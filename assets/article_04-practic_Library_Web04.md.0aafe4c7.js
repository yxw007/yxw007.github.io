import{_ as s,c as a,o as l,A as n}from"./app.8b4a7648.js";const h=JSON.parse('{"title":"创建通用JS公共模块并发布至npm","description":"","frontmatter":{"title":"创建通用JS公共模块并发布至npm","author":"Potter","date":"2022-05-12 18:52","tags":["UMD","rollup","verdaccio","npm"],"categories":["模块化"]},"headers":[{"level":3,"title":"概要内容","slug":"概要内容","link":"#概要内容","children":[]},{"level":3,"title":"如何创建JS公共模块","slug":"如何创建js公共模块","link":"#如何创建js公共模块","children":[]},{"level":3,"title":"rollup","slug":"rollup","link":"#rollup","children":[]},{"level":3,"title":"verdaccio","slug":"verdaccio","link":"#verdaccio","children":[]},{"level":3,"title":"发布至verdaccio平台","slug":"发布至verdaccio平台","link":"#发布至verdaccio平台","children":[]},{"level":3,"title":"发布至npm平台","slug":"发布至npm平台","link":"#发布至npm平台","children":[{"level":4,"title":"参考文献：","slug":"参考文献","link":"#参考文献","children":[]}]}],"relativePath":"article/04-practic/Library/Web04.md","lastUpdated":1678948780000}'),e={name:"article/04-practic/Library/Web04.md"},p=n(`<h3 id="概要内容" tabindex="-1">概要内容 <a class="header-anchor" href="#概要内容" aria-hidden="true">#</a></h3><ul><li>创建：JS公共模块</li><li>打包：使用rollup 打包公共模块</li><li>发布：js公共模块至verdaccio平台</li><li>发布：js公共模块至npm平台</li></ul><hr><h3 id="如何创建js公共模块" tabindex="-1">如何创建JS公共模块 <a class="header-anchor" href="#如何创建js公共模块" aria-hidden="true">#</a></h3><blockquote><p>由于代码有点多就不贴代码了，直接去代码仓库看吧 <a href="https://github.com/aa4790139/JSCommonUtils" target="_blank" rel="noreferrer">传输门</a></p></blockquote><hr><h3 id="rollup" tabindex="-1">rollup <a class="header-anchor" href="#rollup" aria-hidden="true">#</a></h3><ul><li>简介： <blockquote><p>Rollup 是一个 JavaScript 模块打包器，可以将小块代码编译成大块复杂的代码，例如 library 或应用程序。</p></blockquote></li><li>使用起因： <blockquote><p>公共相关的js文件想弄成单独的一个模块，方便后续开发使用，而不是不停的copy 和paste，所以就去了解怎么样把js公共相关js 打包成一个模块。</p></blockquote></li><li>安装<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">pnpm install -g rollup</span></span>
